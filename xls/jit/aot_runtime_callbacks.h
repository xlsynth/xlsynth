...
#ifndef XLS_JIT_AOT_RUNTIME_CALLBACKS_H_
#define XLS_JIT_AOT_RUNTIME_CALLBACKS_H_
...
namespace aot_runtime_callbacks {

// Shared assertion callback used by every XLS runtime that executes the AOT
// callback ABI.
...
#endif  // XLS_JIT_AOT_RUNTIME_CALLBACKS_H_
