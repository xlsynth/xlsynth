...
TEST(FunctionJitTest, PackedAndUnpackedSmokeWide) {
  ...
  alignas(16) uint8_t input_data[16] = {0x1, 0x2, 0x3, 0x4, 0x5,
                                        0x6, 0x7, 0x8, 0x9, 0xa};
  {
