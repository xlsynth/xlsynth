...
def _xls_pass_registry_impl(ctx):
    ...
    if comp_out.objects.to_list() == [] and comp_out.pic_objects.to_list() == []:
        ...
        comp_ctx = cc_common.merge_compilation_contexts([comp_ctx, dummy_comp_ctx])
        comp_out = cc_common.merge_compilation_outputs([comp_out, dummy_comp_out])
