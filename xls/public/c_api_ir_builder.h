...
xls_value* xls_builder_base_add_trace(struct xls_builder_base* builder,
                                      struct xls_bvalue* condition,
                                      struct xls_bvalue** args,
                                      int64_t arg_count,
                                      const char* format_string,
                                      int64_t verbosity, const char* name);

xls_bvalue* xls_builder_base_add_cover(struct xls_builder_base* builder,
                                       struct xls_bvalue* condition,
                                       const char* label, const char* name);

xls_bvalue* xls_builder_base_add_gate(struct xls_builder_base* builder,
                                      struct xls_bvalue* data,
                                      const char* name);
