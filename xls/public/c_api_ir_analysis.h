...
//
// In v1, node queries are keyed by `xls::Node::id()` (an `int64_t`). The C API
// does not yet expose a node enumeration facility; callers are expected to
// obtain node ids out-of-band (e.g. from IR text dumps).
...
// Opaque interval set handle (bits-typed values only in v1).
