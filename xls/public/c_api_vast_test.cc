...
TEST(XlsCApiTest, VastGenerateLoopElementwiseAssignment) {
  ...
  // Add a macro statement using a MacroRef.
  xls_vast_macro_ref* mr = xls_vast_verilog_file_make_macro_ref(f, "MY_MACRO");
  xls_vast_generate_loop_add_macro_statement(loop, mr);
...
TEST(XlsCApiTest, VastMacroStatements) {
  ...
  xls_vast_macro_statement* ms1 =
      xls_vast_verilog_file_make_macro_statement(f, mr1);
  ...
  xls_vast_macro_statement* ms2 =
      xls_vast_verilog_file_make_macro_statement(f, mr2);
  ...
  xls_vast_macro_statement* ms3 =
      xls_vast_verilog_file_make_macro_statement(f, mr3);
  ...
  xls_vast_macro_statement* ms4 =
      xls_vast_verilog_file_make_macro_statement(f, mr4);
