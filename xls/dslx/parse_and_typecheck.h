...
//
// The returned module is the canonical AST and may replace the parsed module.
// Pointers retained from the parsed AST may be invalidated. Use nodes from the
// returned module, whose lifetime is tied to import_data.
//
