...
class TypeInfo {
 public:
  ...
  // import cache.
  void AddImport(std::variant<Use*, Import*> import, Module* module, TypeInfo* type_info);
  ...
  const absl::flat_hash_map<std::variant<Use*, Import*>, ImportedInfo>& imports() const {
    return imports_;
  }
