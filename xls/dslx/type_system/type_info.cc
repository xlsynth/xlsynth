...
void TypeInfo::AddImport(std::variant<UseTreeEntry*, Import*> import, Module* module,
                         TypeInfo* type_info) {
...
absl::StatusOr<ImportedInfo*> TypeInfo::GetImportedOrError(UseTreeEntry* use_tree_entry) {
