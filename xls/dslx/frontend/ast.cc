...
UseSubject::UseSubject(std::vector<std::string> identifiers, NameDef& name_def, UseTreeEntry& use_tree_entry)
    : identifiers_(std::move(identifiers)), name_def_(&name_def), use_tree_entry_(&use_tree_entry) {}
