...
module semantic_sum_consumer;
  ...
  // An ordinary case sends undeclared encodings and X/Z tags to default.
  ...
  // Verifies: the generated package and compiled DSLX exchange the same bits.
  // Catches: four-state tag loss, broken views, and altered payload padding.
  initial begin
