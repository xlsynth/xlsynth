...
fn num_bits_overlapping(NB_A: u32, BE_A: s32, NB_B: u32, BE_B: s32) -> u32 {
...
fn aligned_width(NB_A: u32, BE_A: s32, NB_B: u32, BE_B: s32) -> u32 {
...
// TODO consolidate vs apfloat implementation?
...
//
// Note: discards the signedness.
pub fn to_bits<NB: u32, EN: u32, BU: u32>(x: FixedPoint<NB, EN, BU>) -> uN[NB] {
    x.significand as uN[NB]
}

// Splits an unsigned integer into (N most significant bits, the remaining least significant
// bits).
//
...
// Splits an unsigned integer into (the remainng most significant bits, N least significant
// bits).
//
// TODO move into std.x
...
// Concatenates the tuple elements together. Use bits_to_tuple3 to undo.
//
// Returns n as the msbs, o as the middle bits, and p as the lsbs.
//
// tuple3_to_bits<N, O, P> is the inverse of bits_to_tuple3<N, O, P>.
//
// Matches the compiler's "endianness" for tuples:
// https://github.com/google/xls/blob/83bd722999d7b96f2a2dda5064e64d027651b20c/xls/codegen/flattening.h#L36-L37
pub fn tuple3_to_bits<N: u32, O: u32, P: u32, R: u32 = {N + O + P}>
    (nop: (uN[N], uN[O], uN[P])) -> uN[R] {
    nop.0 ++ nop.1 ++ nop.2
}

// Splits bits into a tuple of three elements.
//
// bits_to_tuple3<N, O, P> returns (uN[N], uN[O], uN[P]).
//
// bits_to_tuple3<N, O, P> is the inverse of tuple3_to_bits<N, O, P>.
pub fn bits_to_tuple3<N: u32, O: u32, P: u32, R: u32 = {N + O + P}>
    (nop: uN[R]) -> (uN[N], uN[O], uN[P]) {
    let (n, op) = split_n_msbs<N>(nop);
    let (o, p) = split_n_msbs<O>(op);
    (n, o, p)
}

// ++++ Tests ++++
#[quickcheck(exhaustive)]
fn prop_bits_to_tuple3_inverses(n: uN[4], o: uN[3], p: uN[5]) -> bool {
    let (n2, o2, p2) = bits_to_tuple3<4, 3, 5>(tuple3_to_bits((n, o, p)));
    n == n2 && o == o2 && p == p2
}
