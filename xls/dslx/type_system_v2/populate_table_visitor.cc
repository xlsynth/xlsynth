 ...
 public:
  ...
  absl::Status HandleTuplePatternChild(
    ...
    if (use_right_based_index_in_type) {
      ...
      Span generated_span =
          SelectSpanForGeneratedNode(module_, {GetPatternSpan(child)});
      XLS_ASSIGN_OR_RETURN(
          Number * index,
          MakeTypeCheckedNumber(module_, table_, generated_span, i,
                                CreateU32Annotation(module_, generated_span)));
      element_type =
