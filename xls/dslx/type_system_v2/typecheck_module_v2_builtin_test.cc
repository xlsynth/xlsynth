...
TEST(TypecheckV2BuiltinTest, BitCountSemanticSumInfersUnsignedExplicitTagType) {
  EXPECT_THAT(R"(
enum Choice {
  Low(u8) = 0,
  High(u8) = 3,
...
TEST(TypecheckV2BuiltinTest, BitCountSemanticSumInfersSignedExplicitTagType) {
  EXPECT_THAT(R"(
enum SignedChoice {
  Negative() = -1,
  Zero() = 0,
