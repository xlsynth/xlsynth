...
absl::StatusOr<TrackedBValue> Translator::CreateMaskedIOOpInput(
...
absl::StatusOr<IOOp*> Translator::AddOpToChannel(
    IOOp& op, IOChannel* channel, const xls::SourceInfo& loc,
    bool do_default_mask, bool no_before_slice,
